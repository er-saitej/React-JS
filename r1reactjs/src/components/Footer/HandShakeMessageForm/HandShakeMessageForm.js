    ...
    return (
        <form className="handShakeMessageForm" onSubmit={(e)=>handleFormSubmit(e)}>
            <div>
                ...
                <input name="name" ref={autoFocusReference} type="text" required autoFocus value={handShakeForm.name} onChange={(e)=>handleHandShakeForm(e)} placeholder='Enter your name here' className='form-control' autoComplete='off' />
            ...
            <div>
                ...
                <input name="email" type="email" required value={handShakeForm.email} onChange={(e)=>handleHandShakeForm(e)} placeholder='Enter your email here' className='form-control' autoComplete='off' />
            ...
            <div>
                ...
                <textarea name="message" type="text" required value={handShakeForm.message} onChange={(e)=>handleHandShakeForm(e)} placeholder='Enter your message here' className='form-control' autoComplete='off' />
